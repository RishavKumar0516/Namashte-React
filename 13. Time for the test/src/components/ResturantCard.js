...
const RestaurantCard = (props) => {
  ...
  return (
    <div data-testid="res-card" className="m-4 p-4 w-[250px] bg-gray-100 rounded-lg hover:bg-gray-200">
      <img
...
export const withPromotedLabel = (RestaurantCard) => {  //here we are receiving the component as input
   return (promps) => { //here we will receive the props of the component.
...
export const addPrompotedLabel = (RestaurantCard) => {
    return (props) => {
       return (
           <div>
            <label className="absolute bg-yellow-300 text-black p-3 rounded-lg mx-6 mt-2">Promoted</label>
