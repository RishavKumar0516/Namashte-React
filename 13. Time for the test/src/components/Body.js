...
<div className="flex gap-5 px-4 justify-between">
        ...
        <input data-testid="search-input" className="border border-solid border-black px-2 py-1 rounded-lg" placeholder="search a restaurant you want..." value={searchText} onChange={handleSearch} />
